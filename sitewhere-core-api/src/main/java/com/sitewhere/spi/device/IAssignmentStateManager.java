...
public interface IAssignmentStateManager extends ITenantLifecycleComponent {
	 ...
	 * 
	 * @param token unique assignment token
	 * @param location assignment location information
	 ...
	 * 
	 * @param token unique assignment tmeasurementsoken
	 * @param measurements assignment location information
	 * @throws SiteWhereException if error in implementation
	 */
	 ...
	 * 
	 * @param token unique assignment token
	 * @param alert assignment alert information
	 * @throws SiteWhereException if error in implementation
	 */
	 ...
	 * 
	 * @param token unique assignment token
	 * @param state assignment state change information
	 * @throws SiteWhereException if error in implementation
	 */
