...
import com.sitewhere.rules.spi.kafka.IEnrichedEventsConsumer;
 ...
 * @author Derek
 */
public class EnrichedEventsConsumer extends MicroserviceKafkaConsumer implements IEnrichedEventsConsumer {
    ...
    /** Suffix for group id */
    private static String GROUP_ID_SUFFIX = "rule-processor-consumers";
    ...
    public EnrichedEventsConsumer(IRuleProcessingTenantEngine tenantEngine) {
    ...
    /**
     * Processor that unmarshals an enriched event and forwards it for processing by
     * rule processors.
     * 
     * @author Derek
     */
