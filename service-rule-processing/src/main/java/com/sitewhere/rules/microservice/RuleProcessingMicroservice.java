...
public class RuleProcessingMicroservice extends
     ...
     */
    @Override
    public IRuleProcessingTenantEngine createTenantEngine(SiteWhereTenantEngine engine) throws SiteWhereException {
	return new RuleProcessingTenantEngine(engine);
    }
