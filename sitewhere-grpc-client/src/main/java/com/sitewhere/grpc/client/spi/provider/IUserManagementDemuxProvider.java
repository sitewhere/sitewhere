...
/**
 * Interface declared by microservices that provide GRPC access to user
 * management.
 * 
 * @author Derek
 *
 * @param <T>
 */
public interface IUserManagementDemuxProvider<T extends IFunctionIdentifier> extends IMicroservice<T> {
