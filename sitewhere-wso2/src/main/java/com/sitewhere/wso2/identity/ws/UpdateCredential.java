...
public class UpdateCredential {
    ...
    @XmlElementRef(name = "newCredential", namespace = "http://service.ws.um.carbon.wso2.org", type = JAXBElement.class)
    protected JAXBElement<String> newCredential;
    @XmlElementRef(name = "oldCredential", namespace = "http://service.ws.um.carbon.wso2.org", type = JAXBElement.class)
    ...
    public void setNewCredential(JAXBElement<String> value) {
        this.newCredential = ((JAXBElement<String> ) value);
    }
    ...
    public void setOldCredential(JAXBElement<String> value) {
        this.oldCredential = ((JAXBElement<String> ) value);
    }
