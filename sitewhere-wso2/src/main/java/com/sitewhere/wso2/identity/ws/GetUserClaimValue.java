...
@XmlRootElement(name = "getUserClaimValue")
public class GetUserClaimValue {
    ...
    @XmlElementRef(name = "claim", namespace = "http://service.ws.um.carbon.wso2.org", type = JAXBElement.class)
    ...
    public void setClaim(JAXBElement<String> value) {
        this.claim = ((JAXBElement<String> ) value);
    }
