...
public interface RemoteUserStoreManagerServicePortType {
    ...
    public void setUserClaimValues(
        ...
        java.util.List<com.sitewhere.assetmanagement.modules.wso2.ws.ClaimValue> claims,
    ...
    public java.util.List<com.sitewhere.assetmanagement.modules.wso2.ws.ClaimValue> getUserClaimValuesForClaims(
        @WebParam(name = "userName", targetNamespace = "http://service.ws.um.carbon.wso2.org")
        java.lang.String userName,
        @WebParam(name = "claims", targetNamespace = "http://service.ws.um.carbon.wso2.org")
    ...
    public void addRole(
        ...
        java.util.List<com.sitewhere.assetmanagement.modules.wso2.ws.PermissionDTO> permissions
    );
    ...
    public java.util.List<com.sitewhere.assetmanagement.modules.wso2.ws.ClaimDTO> getUserClaimValues(
        @WebParam(name = "userName", targetNamespace = "http://service.ws.um.carbon.wso2.org")
        java.lang.String userName,
        @WebParam(name = "profileName", targetNamespace = "http://service.ws.um.carbon.wso2.org")
        java.lang.String profileName
    ...
    public java.util.List<com.sitewhere.assetmanagement.modules.wso2.ws.ArrayOfString> getProperties(
        @WebParam(name = "tenant", targetNamespace = "http://service.ws.um.carbon.wso2.org")
        com.sitewhere.assetmanagement.modules.wso2.ws.AX2604Tenant tenant
    ) throws RemoteUserStoreManagerServiceUserStoreException_Exception;
