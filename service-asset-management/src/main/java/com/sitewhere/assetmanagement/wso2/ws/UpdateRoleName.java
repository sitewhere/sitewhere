...
@XmlRootElement(name = "updateRoleName")
public class UpdateRoleName {
    ...
    @XmlElementRef(name = "newRoleName", namespace = "http://service.ws.um.carbon.wso2.org", type = JAXBElement.class)
    protected JAXBElement<String> newRoleName;
     ...
     *     
     */
    public JAXBElement<String> getNewRoleName() {
        return newRoleName;
    }
     ...
     *     
     */
    public void setNewRoleName(JAXBElement<String> value) {
        this.newRoleName = ((JAXBElement<String> ) value);
    }
