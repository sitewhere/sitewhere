...
public class HBaseAsset {
	...
	// same.
	PersonAsset asset = AssetManagementPersistence.personAssetCreateLogic(category, request);
	...
	// Use common processing logic so all backend implementations work the
	// same.
	HardwareAsset asset = AssetManagementPersistence.hardwareAssetCreateLogic(category, request);
	...
	// Use common processing logic so all backend implementations work the
	// same.
	LocationAsset asset = AssetManagementPersistence.locationAssetCreateLogic(category, request);
