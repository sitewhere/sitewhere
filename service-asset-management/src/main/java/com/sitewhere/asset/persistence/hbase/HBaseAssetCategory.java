...
public class HBaseAssetCategory {
	...
	return HBaseUtils.createOrUpdate(context, context.getPayloadMarshaler(), ISiteWhereHBase.ASSETS_TABLE_NAME,
		category, id, KEY_BUILDER, qualifiers);
    }
     ...
     * @throws SiteWhereException
     */
    public static AssetCategory getAssetCategoryById(IHBaseContext context, String id) throws SiteWhereException {
	if (KEY_BUILDER.getMap(context).getValue(id) == null) {
	    return null;
	}
	return HBaseUtils.get(context, ISiteWhereHBase.ASSETS_TABLE_NAME, id, KEY_BUILDER, AssetCategory.class);
    }
	...
	AssetManagementPersistence.assetCategoryUpdateLogic(request, updated);
	return HBaseUtils.put(context, context.getPayloadMarshaler(), ISiteWhereHBase.ASSETS_TABLE_NAME, updated, id,
		KEY_BUILDER);
    }
     ...
     * @throws SiteWhereException
     */
    public static SearchResults<IAssetCategory> listAssetCategories(IHBaseContext context, ISearchCriteria criteria)
	    throws SiteWhereException {
     ...
     * @throws SiteWhereException
     */
    public static AssetCategory deleteAssetCategory(IHBaseContext context, String id) throws SiteWhereException {
	// TODO: Delete all assets.
	return HBaseUtils.forcedDelete(context, context.getPayloadMarshaler(), ISiteWhereHBase.ASSETS_TABLE_NAME, id,
		KEY_BUILDER, AssetCategory.class);
    }
     ...
     * @throws SiteWhereException
     */
    public static AssetCategory assertAssetCategory(IHBaseContext context, String id) throws SiteWhereException {
