...
/**
 * Client for WSO2 remote user store manager service using ksoap2 for
 * lightweight SOAP container.
 */
public class Wso2SoapClient {
    ...
    /**
     * Call to turn off SSL certificate checking. This should only be done for
     * testing!
     */
