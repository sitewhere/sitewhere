...
public class DataManagementModel extends ConfigurationModel {
	...
	ElementNode.Builder builder = new ElementNode.Builder("MongoDB/Hazelcast Tenant Datastore",
		TenantDatastoreParser.Elements.MongoHazelcastDbTenantDatastore.getLocalName(), "database",
		ElementRole.DataManagement_Datastore);
	...
	builder.attribute((new AttributeNode.Builder("Event expiration", "expirationInMin", AttributeType.Integer)
		.description("Number of minutes events are kept in memory before expiring.").group("conn")
