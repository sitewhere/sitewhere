...
public class ExampleData {
    ...
    /** Assignment */
    public static Assignment_HeartMonitorToDerek HEART_MONITOR_TO_DEREK = new Assignment_HeartMonitorToDerek();
	...
	public Hardware_Meitrack() {
	    ...
	    setSku("MT90");
	    setDescription(
		    "MT90 is a waterproof GPS personal tracker suitable for lone workers, kids, aged, pet, assets, vehicle and fleet management.");
	...
	public Schedule_Simple1() {
	    IScheduleCreateRequest request = ScheduleHelper.createSimpleSchedule("95ff6a81-3d92-4b10-b8af-957c172ad97b",
		    "Every thirty seconds", new Date(), new Date(), (long) 30 * 1000, 0);
	...
	public Schedule_Cron1() {
	    IScheduleCreateRequest request = ScheduleHelper.createCronSchedule("5e772533-9fd8-4daa-8da1-63aa6642cc30",
		    "On the hour", new Date(), new Date(), "0 0 0/1 1/1 * ? *");
	    setToken(request.getToken());
	    setName(request.getName());
	    setTriggerType(request.getTriggerType());
	    setTriggerConfiguration(request.getTriggerConfiguration());
