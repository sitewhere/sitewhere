...
/**
 * Mock version of {@link IAssetModuleManager} that always returns the same
 * asset.
 * 
 * @author Derek
 */
public class MockAssetModuleManager extends AssetModuleManager {
     ...
     * 
     * @see
     * com.sitewhere.server.asset.AssetModuleManager#getAssetById(java.lang.
	...
	if (match == null) {
	    throw new SiteWhereException("Missing sample asset: assetModuleId:" + assetModuleId + " assetId:" + id);
	}
	return match;
    }
}