...
/**
 * Helper class that simplifies use of Spring {@link RestTemplate} for scripting.
 * 
 * @author Derek
 */
public class RestHelper {
	...
	public RestHelper(String baseUrl, String username, String password) {
		...
		this.client =
				isIgnoreBadCertificate() ? new RestTemplate(createSecureTransport()) : new RestTemplate();
