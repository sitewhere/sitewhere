...
public class ConfigurationUtils {
	...
	/**
	 * Builds a Spring {@link ApplicationContext} from a byte array containing the XML
	 * configuration.
	 * 
	 * @param configuration
	 * @param version
	...
	/**
	 * Build a Spring {@link ApplicationContext} from a byte array containing a tenant
	 ...
	 * @throws SiteWhereException
	 */
	public static ApplicationContext buildTenantContext(byte[] configuration, ITenant tenant,
			IVersion version, ApplicationContext global) throws SiteWhereException {
