 ...
 * @author Derek
 */
public class DefaultCommandProcessingStrategy extends TenantLifecycleComponent implements
	 ...
	 * 
	 * @see
	 * com.sitewhere.spi.device.communication.ICommandProcessingStrategy#deliverCommand
	...
	public void deliverCommand(IDeviceCommunication communication, IDeviceCommandInvocation invocation)
		...
		if (command != null) {
			...
			for (IDeviceAssignment assignment : assignments) {
				IDevice device =
						SiteWhere.getServer().getDeviceManagement(getTenant()).getDeviceForAssignment(
								assignment);
				if (device == null) {
				...
				IDeviceNestingContext nesting =
						NestedDeviceSupport.calculateNestedDeviceInformation(device, getTenant());
	 ...
	 * 
	 * @see
	 * com.sitewhere.spi.device.communication.ICommandProcessingStrategy#deliverSystemCommand
	 * (com.sitewhere.spi.device.communication.IDeviceCommunication, java.lang.String,
