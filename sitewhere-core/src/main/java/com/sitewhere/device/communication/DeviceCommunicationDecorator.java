...
/**
 * Uses decorator pattern to wrap a delegate {@link IDeviceCommunication} implementation
 * and override pieces of the functionality.
 * 
 * @author Derek
 */
public class DeviceCommunicationDecorator extends LifecycleComponentDecorator
		implements IDeviceCommunication {
