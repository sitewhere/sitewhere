...
public abstract class FilteredOutboundEventProcessor extends OutboundEventProcessor implements
	 ...
	 * 
	 * @see
	 * com.sitewhere.device.event.processor.OutboundEventProcessor#onCommandResponse(com
	 ...
	 * 
	 * @see
	 * com.sitewhere.spi.device.event.processor.IFilteredOutboundEventProcessor#getFilters
	 * ()
	 */
