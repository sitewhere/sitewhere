...
public class PersonAssetCreateRequest extends AssetCreateRequest implements IPersonAssetCreateRequest {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sitewhere.spi.asset.request.IPersonAssetCreateRequest#getUserName()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sitewhere.spi.asset.request.IPersonAssetCreateRequest#getEmailAddress()
	 */
