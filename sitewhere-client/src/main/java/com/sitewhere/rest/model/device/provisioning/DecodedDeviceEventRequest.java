/*
 * DecodedDeviceEventRequest.java 
 * --------------------------------------------------------------------------------------
...
public class DecodedDeviceEventRequest implements IDecodedDeviceEventRequest {
	 ...
	 * 
	 * @see
	 * com.sitewhere.spi.device.provisioning.IDecodedDeviceEventRequest#getHardwareId()
	 */
	 ...
	 * 
	 * @see
	 * com.sitewhere.spi.device.provisioning.IDecodedDeviceEventRequest#getOriginator()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sitewhere.spi.device.provisioning.IDecodedDeviceEventRequest#getRequest()
	 */
