...
public class DeviceStateChangeCreateRequest extends DeviceEventCreateRequest implements IDeviceStateChangeCreateRequest {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sitewhere.spi.device.event.request.IDeviceStateChangeRequest#getCategory()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sitewhere.spi.device.event.request.IDeviceStateChangeRequest#getType()
	 */
	 ...
	 * 
	 * @see
	 * com.sitewhere.spi.device.event.request.IDeviceStateChangeRequest#getPreviousState()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sitewhere.spi.device.event.request.IDeviceStateChangeRequest#getNewState()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sitewhere.spi.device.event.request.IDeviceStateChangeRequest#getData()
	 */
