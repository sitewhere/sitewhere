...
/**
 * Microservice that provides command destinations functionality.
 * 
 * @author Derek
 */
public class CommandDestinationsMicroservice extends MultitenantMicroservice<ICommandDestinationsTenantEngine>
	implements ICommandDestinationsMicroservice {
    ...
    /** Configuration model */
    private IConfigurationModel configurationModel = new CommandDestinationsModel(this);
     ...
     */
    @Override
    public ICommandDestinationsTenantEngine createTenantEngine(ITenant tenant) throws SiteWhereException {
	return new CommandDestinationsTenantEngine(this, tenant);
    }
