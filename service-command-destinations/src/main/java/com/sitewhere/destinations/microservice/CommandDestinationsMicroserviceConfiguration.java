 ...
 */
@Configuration
public class CommandDestinationsMicroserviceConfiguration {

    @Bean
    public ICommandDestinationsMicroservice batchOperationsMicroservice() {
	return new CommandDestinationsMicroservice();
    }
}