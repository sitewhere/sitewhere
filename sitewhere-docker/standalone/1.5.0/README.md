# SiteWhere 1.5.0 CE Standalone Docker Image
This image includes a complete self-contained installation of SiteWhere 1.5.0, 
...
```
docker build -t sitewhere/standalone:1.5.0 .
```
...
```
docker run -p 80:8080 -p 1883:1883 -p 61623:61623 sitewhere/standalone:1.5.0
```
