...
/**
 * Configuration roles available for schedule management microservice.
 * 
 * @author Derek
 */
public enum ScheduleManagementRoles implements IConfigurationRoleProvider {
    ...
    private ScheduleManagementRoles(ConfigurationRole role) {
	this.role = role;
    }
