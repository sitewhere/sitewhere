...
/**
 * Implementation of {@link IPayloadMarshaler} that uses Google Protocol Buffers
...
public class ProtobufPayloadMarshaler extends JsonPayloadMarshaler implements IPayloadMarshaler {
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#encode(java.lang.Object)
     */
    @Override
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#encodeSite(com.sitewhere
     * .spi. device .ISite)
     */
    @Override
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#encodeZone(com.sitewhere
     * .spi. device .IZone)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sitewhere.hbase.encoder.JsonPayloadMarshaler#
     * encodeDeviceSpecification(com. sitewhere.spi.device.IDeviceSpecification)
     */
    @Override
    public byte[] encodeDeviceSpecification(IDeviceSpecification spec) throws SiteWhereException {
	ProtobufMarshaler.DeviceSpecification.Builder builder = ProtobufMarshaler.DeviceSpecification.newBuilder();
     ...
     * 
     * @see com.sitewhere.hbase.encoder.JsonPayloadMarshaler#
     * decodeDeviceSpecification(byte[])
     */
    @Override
    public DeviceSpecification decodeDeviceSpecification(byte[] payload) throws SiteWhereException {
	ByteArrayInputStream stream = new ByteArrayInputStream(payload);
	try {
	    ProtobufMarshaler.DeviceSpecification pb = ProtobufMarshaler.DeviceSpecification.parseFrom(stream);
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#encodeDeviceCommand(com.
	...
	for (ICommandParameter parameter : command.getParameters()) {
	    ProtobufMarshaler.CommandParameter.Builder cbuilder = ProtobufMarshaler.CommandParameter.newBuilder();
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#decodeDeviceCommand(byte
     * [])
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.sitewhere.hbase.encoder.JsonPayloadMarshaler#encodeDevice(com.
	...
	for (IDeviceElementMapping mapping : device.getDeviceElementMappings()) {
	    ProtobufMarshaler.DeviceElementMapping.Builder ebuilder = ProtobufMarshaler.DeviceElementMapping
		    .newBuilder();
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#decodeDevice(byte[])
     */
    @Override
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#encodeDeviceLocation(com
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#decodeDeviceLocation(
     * byte[])
     */
    @Override
     ...
     * @throws SiteWhereException
     */
    protected DeviceLocation unmarshalDeviceLocation(ProtobufMarshaler.DeviceLocation pb) throws SiteWhereException {
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#encodeDeviceMeasurements
     * (com. sitewhere .spi.device.event.IDeviceMeasurements)
     */
    @Override
    public byte[] encodeDeviceMeasurements(IDeviceMeasurements measurements) throws SiteWhereException {
	ProtobufMarshaler.DeviceMeasurements.Builder builder = ProtobufMarshaler.DeviceMeasurements.newBuilder();
	for (String key : measurements.getMeasurements().keySet()) {
	    ProtobufMarshaler.DeviceMeasurement.Builder mbuilder = ProtobufMarshaler.DeviceMeasurement.newBuilder();
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#decodeDeviceMeasurements
     * (byte[])
     */
    @Override
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#encodeDeviceAlert(com.
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#decodeDeviceAlert(byte[]
     * )
     */
    @Override
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#encodeDeviceStreamData(
     * com. sitewhere .spi.device.event.IDeviceStreamData)
     */
    public byte[] encodeDeviceStreamData(IDeviceStreamData streamData) throws SiteWhereException {
	try {
	    ProtobufMarshaler.DeviceStreamData.Builder builder = ProtobufMarshaler.DeviceStreamData.newBuilder();
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#decodeDeviceStreamData(
     * byte[])
     */
     ...
     * 
     * @see com.sitewhere.hbase.encoder.JsonPayloadMarshaler#
     * encodeDeviceCommandInvocation(
     * com.sitewhere.spi.device.event.IDeviceCommandInvocation)
     */
    @Override
    public byte[] encodeDeviceCommandInvocation(IDeviceCommandInvocation invocation) throws SiteWhereException {
	try {
	    ProtobufMarshaler.DeviceCommandInvocation.Builder builder = ProtobufMarshaler.DeviceCommandInvocation
		    .newBuilder();
	...
	ByteArrayInputStream stream = new ByteArrayInputStream(payload);
	try {
	    ProtobufMarshaler.DeviceCommandInvocation pb = ProtobufMarshaler.DeviceCommandInvocation.parseFrom(stream);
     ...
     * 
     * @see com.sitewhere.hbase.encoder.JsonPayloadMarshaler#
     * encodeDeviceCommandResponse(com
	...
	try {
	    ProtobufMarshaler.DeviceCommandResponse.Builder builder = ProtobufMarshaler.DeviceCommandResponse
		    .newBuilder();
     ...
     * 
     * @see com.sitewhere.hbase.encoder.JsonPayloadMarshaler#
     * decodeDeviceCommandResponse(byte [])
     */
    @Override
    public DeviceCommandResponse decodeDeviceCommandResponse(byte[] payload) throws SiteWhereException {
	ByteArrayInputStream stream = new ByteArrayInputStream(payload);
	try {
	    ProtobufMarshaler.DeviceCommandResponse pb = ProtobufMarshaler.DeviceCommandResponse.parseFrom(stream);
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#encodeDeviceAssignment(
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#decodeDeviceAssignment(
     * byte[])
     */
    @Override
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#encodeDeviceStream(com.
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#decodeDeviceStream(byte[
     * ])
     */
     ...
     * 
     * @see com.sitewhere.hbase.encoder.JsonPayloadMarshaler#
     * encodeDeviceAssignmentState(com
	...
	ProtobufMarshaler.DeviceAssignmentState.Builder builder = ProtobufMarshaler.DeviceAssignmentState.newBuilder();
     ...
     * 
     * @see com.sitewhere.hbase.encoder.JsonPayloadMarshaler#
     * decodeDeviceAssignmentState(byte [])
     */
    @Override
    public DeviceAssignmentState decodeDeviceAssignmentState(byte[] payload) throws SiteWhereException {
	ByteArrayInputStream stream = new ByteArrayInputStream(payload);
	try {
	    ProtobufMarshaler.DeviceAssignmentState pb = ProtobufMarshaler.DeviceAssignmentState.parseFrom(stream);
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#encodeDeviceGroup(com.
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#decodeDeviceGroup(byte[]
     * )
     */
    @Override
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#encodeDeviceGroupElement
	...
	ProtobufMarshaler.DeviceGroupElement.Builder builder = ProtobufMarshaler.DeviceGroupElement.newBuilder();
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#decodeDeviceGroupElement
     * (byte[])
     */
    @Override
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#encodeBatchOperation(com
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#decodeBatchOperation(
     * byte[])
     */
    @Override
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#encodeBatchElement(com.
     ...
     * 
     * @see
     * com.sitewhere.hbase.encoder.JsonPayloadMarshaler#decodeBatchElement(byte[
     * ])
     */
    @Override
	...
	ProtobufMarshaler.DeviceElementSchema.Builder builder = ProtobufMarshaler.DeviceElementSchema.newBuilder();
     ...
     * @return
     */
    protected ProtobufMarshaler.ElementProcessingStatus marshalElementProcessingStatus(ElementProcessingStatus type) {
	switch (type) {
	case Failed: {
     ...
     * @return
     */
    protected ElementProcessingStatus unmarshalElementProcessingStatus(ProtobufMarshaler.ElementProcessingStatus type) {
	switch (type) {
	case EPSFailed: {
	...
	for (String key : metadata.keySet()) {
	    ProtobufMarshaler.MetadataEntry entry = ProtobufMarshaler.MetadataEntry.newBuilder().setName(key)
		    .setValue(metadata.get(key)).build();
	    entries.add(entry);
	}
	return entries;
    }
