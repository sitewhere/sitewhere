...
public class HBaseSchedule {
	...
	public static Schedule createSchedule(IHBaseContext context, IScheduleCreateRequest request)
		...
		return HBaseUtils.createOrUpdate(context, context.getPayloadMarshaler(),
				ISiteWhereHBase.SCHEDULES_TABLE_NAME, schedule, uuid, KEY_BUILDER, qualifiers);
	}
	...
	public static SearchResults<ISchedule> listSchedules(IHBaseContext context, boolean includeDeleted,
		...
		return HBaseUtils.getFilteredList(context, ISiteWhereHBase.SCHEDULES_TABLE_NAME, KEY_BUILDER,
				includeDeleted, ISchedule.class, Schedule.class, filter, criteria, comparator);
	}
	...
	public static ISchedule deleteSchedule(IHBaseContext context, String token, boolean force)
		...
		return HBaseUtils.delete(context, context.getPayloadMarshaler(),
				ISiteWhereHBase.SCHEDULES_TABLE_NAME, token, force, KEY_BUILDER, Schedule.class);
	}

	/**
	 * Get a {@link Schedule} by token or throw an exception if token is not valid.
	 * 
	 * @param context
	 * @param token
	 * @return
