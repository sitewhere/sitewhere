...
public class SiteWhereAuthenticationProvider implements AuthenticationProvider {
    ...
    public SiteWhereAuthenticationProvider(IInstanceManagementMicroservice<?> microservice) {
    ...
    protected void setMicroservice(IInstanceManagementMicroservice<?> microservice) {
	this.microservice = microservice;
    }
}