...
public class RestApiSecurity extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    protected IInstanceManagementMicroservice<?> webRestMicroservice;
    ...
    public IInstanceManagementMicroservice<?> getWebRestMicroservice() {
	return webRestMicroservice;
    }

    public void setWebRestMicroservice(IInstanceManagementMicroservice<?> webRestMicroservice) {
