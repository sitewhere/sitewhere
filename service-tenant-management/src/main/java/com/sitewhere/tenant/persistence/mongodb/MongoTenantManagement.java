...
public class MongoTenantManagement extends LifecycleComponent implements ITenantManagement {
	...
	getMongoClient().getTenantsCollection().createIndex(new Document(MongoPersistentEntity.PROP_TOKEN, 1),
	...
	if (criteria.getTextSearch() != null) {
		...
		DBObject idSearch = new BasicDBObject(MongoPersistentEntity.PROP_ID, regex);
