...
public class ZookeeperTenantManagement extends LifecycleComponent implements ITenantManagement {
	...
	// if (existing == null) {
	// getLogger().debug("Zk node for tenant '" + request.getToken() + "' not found.
	// Creating...");
	// return createZookeeperTenant(tenant);
	// } else {
	// throw new SiteWhereSystemException(ErrorCode.DuplicateUser,
	// ErrorLevel.ERROR);
	// }
	// } catch (Exception e) {
	...
	// return null;
	// } catch (Exception e) {
	// throw new SiteWhereException(String.format("Unable to get tenant at path
	// '%s'.", tenantPath));
	// }
	return null;
    }
	...
	// getLogger().info("Unable to retrieve tenant for list. Data may be corrupt.",
	// e);
	// }
	// }
	...
	// } catch (Exception e) {
	// throw new SiteWhereException("Unable to retrieve tenant list from
	// Zookeeper.", e);
	// }
	return null;
    }
	...
	// getMicroservice().getZookeeperManager().getCurator();
	// String path =
	// getConfigurableMicroservice().getInstanceTenantConfigurationPath(tenantId);
	...
	// return tenant;
	// } catch (Exception e) {
	// throw new SiteWhereException("Unable to store tenant information in
	// Zookeeper.", e);
	// }
	return null;
    }
	...
	// curator.setData().forPath(tenantPath,
	// MarshalUtils.marshalJsonAsPrettyString(tenant).getBytes());
	// } else {
	// throw new SiteWhereSystemException(ErrorCode.InvalidTenantId,
	// ErrorLevel.ERROR);
	// }
	// return tenant;
	// } catch (Exception e) {
